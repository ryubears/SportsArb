...
KIND_NOTES = {
    "game_winner": "Ties pay half on every venue. If the game does not start within 48 hours, Kalshi settles at a fair price while Polymarket waits for the game.",
