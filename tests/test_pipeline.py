...
def test_refresh_fetches_classifies_and_pairs(tmp_path, monkeypatch):
    ...
    canned_by_venue = {"kalshi": [canned("kalshi", "KXSB-27-BUF")], "polymarket": [canned("polymarket", "pm-token")]}
    ...
    assert summary == "kalshi 1 contracts, 1 fee records, polymarket 1 contracts, 1 fee records, 2 bets, 1 groups"
